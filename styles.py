...
def apply_theme(theme: str, holiday_effects: list = None):
    ...
    base_css = (
        ...
        "button[data-testid='stBaseButton-secondary'] { background: linear-gradient(135deg, #3498DB 0%, #2980B9 100%) !important; border: none !important; border-radius: 16px !important; padding: 24px 40px !important; margin-bottom: 24px !important; color: white !important; font-size: 32px !important; font-weight: 700 !important; text-align: center !important; white-space: pre-line !important; line-height: 1.6 !important; animation: pulse 2s ease-in-out infinite !important; cursor: pointer !important; width: 100% !important; }"
        "button[data-testid='stBaseButton-secondary']:hover { transform: scale(1.02) !important; box-shadow: 0 8px 24px rgba(52, 152, 219, 0.4) !important; }"
